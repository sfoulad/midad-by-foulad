...
TEST(OtaRollbackDigestFormat, FormatsSha256DigestAsLowercaseHex) {
  ...
  const uint8_t digest[32] = {
      ...
      0x0c, 0x0d, 0x0e, 0x0f, 0xff, 0xa5, 0x5a, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90,
  };
...
TEST(OtaRollbackDigestFormat, EmptyInputProducesEmptyString) { EXPECT_EQ(formatOtaRollbackDigestHex(nullptr, 0), ""); }
