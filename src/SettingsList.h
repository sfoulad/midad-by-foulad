...
inline SettingInfo buildArabicFontFamilySetting(const SdCardFontRegistry* registry) {
  ...
  std::vector<StrId> enumValues = {StrId::STR_NOTO_NASKH_ARABIC, StrId::STR_AMIRI, StrId::STR_NEIRIZI};
  std::vector<std::string> enumStringValues;
...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_ARABIC_FONT_SIZE, &CrossPointSettings::arabicFontSize,
                          {StrId::STR_SMALL, StrId::STR_MEDIUM, StrId::STR_LARGE, StrId::STR_X_LARGE}, "arabicFontSize",
                          StrId::STR_CAT_READER),
