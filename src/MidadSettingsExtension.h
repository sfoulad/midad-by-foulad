...
// the single "Apps" tab appended after CrossPoint's built-in four; every
...
// state changes -- the Foulad eBooks Login/Logout slot in particular -- stay
// current without extra plumbing.
