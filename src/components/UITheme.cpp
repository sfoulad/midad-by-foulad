...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  // Single-theme firmware: Foulad is the only UI theme (the alternatives were
  // removed to reclaim flash). The parameter is kept for signature stability;
  // any legacy saved uiTheme value resolves to Foulad.
  (void)type;
  LOG_DBG("UI", "Using Foulad theme");
  currentTheme = std::make_unique<FouladTheme>();
  currentMetrics = &FouladMetrics::values;
}
